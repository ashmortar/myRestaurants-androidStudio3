...
public class SavedRestaurantListActivity extends AppCompatActivity implements OnStartDragListener {
    ...
    private void setUpFirebaseAdapter() {
        ...
        mFirebaseAdapter = new FirebaseRestaurantListAdapter(Restaurant.class, R.layout.restaurant_list_tem_drag, FirebaseRestaurantViewHolder.class, mRestaurantReference, this, this);
